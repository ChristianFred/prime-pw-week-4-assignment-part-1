...
function addNumbers( firstNum, secondNum ) {
  console.log('These are being added..', firstNum, secondNum);
...
function multiplyThree( firstNum, secondNum, thirdNum ) {
  console.log('These are being multiplied..', firstNum, secondNum, thirdNum);
  let answer = firstNum * secondNum * thirdNum
return answer;
}
  console.log(multiplyThree(12,6,7));
